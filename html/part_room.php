...
if ($login) {
	...
	if ($cnt>0) {
		...
		print "<TD NOWRAP><A HREF=\"./room/\">施設・設備予約</A></TD>";
		print "<TD NOWRAP ALIGN=RIGHT><A HREF=\"./room/add/?p=top\">登録<IMG SRC=\"./image/entrysadd.gif\" WIDTH=10 HEIGHT=9 BORDER=0 ALT=\"新規予約\"></A></TD>";
		print "</TR>";
		...
		for($i=0;$i<$cnt;$i++){
			...
			print "&nbsp;";
			print "<A HREF=\"./room/add/?p=top&id=$room_id\"><IMG SRC=\"./image/entrysadd.gif\" WIDTH=10 HEIGHT=9 BORDER=0 ALT=\"予約の追加\"></A>";
			print "<BR>";
			print "";
			print "</TD></TR>";
