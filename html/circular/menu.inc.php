...
";
  ...
  $menutext .= "</TD><TD>";
  if ($to_not==0) {
    $menutext .= "<A HREF=\"$toppath/circular/?viewtype=notread&viewrange=to\"><FONT STYLE=\"font-weight:normal;text-decoration:none\">未回答</FONT></A><BR>";
  } else {
    $menutext .= "<A HREF=\"$toppath/circular/?viewtype=notread&viewrange=to\">未回答</A> (".number_format($to_not).")<BR>\n";
  }
  $menutext .= "</TD></TR>\n";
  ...
  $menutext .= "</TD><TD>";
  if ($to_has==0) {
    $menutext .= "<A HREF=\"$toppath/circular/?viewtype=hasread&viewrange=to\"><FONT STYLE=\"font-weight:normal;text-decoration:none\">回答済み</FONT></A><BR>\n";
  } else {
    $menutext .= "<A HREF=\"$toppath/circular/?viewtype=hasread&viewrange=to\" STYLE=\"font-weight:normal;\">回答済み</A> (".number_format($to_has).")<BR>\n";
  }
  $menutext .= "</TD></TR>\n";
