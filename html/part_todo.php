...
if ($login) {
	...
	print "<TD NOWRAP><A HREF=\"./todo/\">備忘録</A></TD>";
	print "<TD NOWRAP ALIGN=RIGHT><A HREF=\"./todo/add/?p=top\"><IMG SRC=\"./image/todosadd.gif\" WIDTH=10 HEIGHT=9 BORDER=0 ALIGN=ABSMIDDLE ALT=\"新規メモ\"></A></TD>";
	print "</TR>";
	...
	$cnt = pg_num_rows($res);
	if ($cnt==0) {
		print "<FONT COLOR=#CCCCCC>なし</FONT>\n";
	} else {
